...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.show_in_default'
        db.add_column('pin_post', 'show_in_default',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.show_in_default'
        db.delete_column('pin_post', 'show_in_default')
    ...
    models = {
        ...
        'pin.post': {
            ...
            'show_in_default': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
