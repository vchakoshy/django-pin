...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Comments_score'
        db.create_table('pin_comments_score', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('comment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pin.Comments'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='comment_like_user', to=orm['auth.User'])),
            ('score', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('pin', ['Comments_score'])

        # Adding field 'Comments.score'
        db.add_column('pin_comments', 'score',
                      self.gf('django.db.models.fields.IntegerField')(default=-1, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Comments_score'
        db.delete_table('pin_comments_score')

        # Deleting field 'Comments.score'
        db.delete_column('pin_comments', 'score')
    ...
    models = {
        ...
        'pin.comments': {
            ...
            'score': ('django.db.models.fields.IntegerField', [], {'default': '-1', 'blank': 'True'}),
        ...
        'pin.comments_score': {
            ...
            'comment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pin.Comments']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'score': ('django.db.models.fields.IntegerField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'comment_like_user'", 'to': "orm['auth.User']"})
        },
        'pin.follow': {
        ...
        'pin.report': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'post': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'report_post'", 'to': "orm['pin.Post']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'report_user'", 'to': "orm['auth.User']"})
        },
        'pin.stream': {
