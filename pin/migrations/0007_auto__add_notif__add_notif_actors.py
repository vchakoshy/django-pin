...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('pin', ['Notif'])

        # Adding model 'Notif_actors'
        db.create_table('pin_notif_actors', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('notif', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notif', to=orm['pin.Notif'])),
            ('actor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='actor', to=orm['auth.User'])),
        ))
        db.send_create_signal('pin', ['Notif_actors'])


    def backwards(self, orm):
        # Deleting model 'Notif'
        db.delete_table('pin_notif')

        # Deleting model 'Notif_actors'
        db.delete_table('pin_notif_actors')
