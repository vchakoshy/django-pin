...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Post', fields ['show_in_default']
        db.create_index('pin_post', ['show_in_default'])


    def backwards(self, orm):
        # Removing index on 'Post', fields ['show_in_default']
        db.delete_index('pin_post', ['show_in_default'])
