...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Comments', fields ['is_public']
        db.create_index('pin_comments', ['is_public'])


    def backwards(self, orm):
        # Removing index on 'Comments', fields ['is_public']
        db.delete_index('pin_comments', ['is_public'])
