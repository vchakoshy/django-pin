...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Comments', fields ['reported']
        db.create_index('pin_comments', ['reported'])

        # Adding index on 'Comments', fields ['ip_address']
        db.create_index('pin_comments', ['ip_address'])


    def backwards(self, orm):
        # Removing index on 'Comments', fields ['ip_address']
        db.delete_index('pin_comments', ['ip_address'])

        # Removing index on 'Comments', fields ['reported']
        db.delete_index('pin_comments', ['reported'])
