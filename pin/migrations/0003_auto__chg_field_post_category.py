...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('pin_post', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pin.Category'], null=True))

    def backwards(self, orm):

        # Changing field 'Post.category'
        db.alter_column('pin_post', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['pin.Category']))
    ...
    models = {
        ...
        'pin.post': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'default': '0', 'to': "orm['pin.Category']", 'null': 'True', 'blank': 'True'}),
