...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.cnt_like'
        db.add_column('pin_post', 'cnt_like',
                      self.gf('django.db.models.fields.IntegerField')(default=-1, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.cnt_like'
        db.delete_column('pin_post', 'cnt_like')
    ...
    models = {
        ...
        'pin.post': {
            ...
            'cnt_like': ('django.db.models.fields.IntegerField', [], {'default': '-1', 'blank': 'True'}),
