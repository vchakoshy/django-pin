...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Report'
        db.create_table('pin_report', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='report_user', to=orm['auth.User'])),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(related_name='report_post', to=orm['pin.Post'])),
        ))
        db.send_create_signal('pin', ['Report'])

        # Adding unique constraint on 'Report', fields ['post', 'user']
        db.create_unique('pin_report', ['post_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Report', fields ['post', 'user']
        db.delete_unique('pin_report', ['post_id', 'user_id'])

        # Deleting model 'Report'
        db.delete_table('pin_report')
